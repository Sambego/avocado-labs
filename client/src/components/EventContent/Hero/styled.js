...
// this style positions the span generated by Waypoint
// in a specific position in order to trigger the
// change correctly

export const TopWaypoint = styled.span`
  position: absolute;
  top: 250px;
`

export const MiddleWaypoint = styled.span`
  position: absolute;
  bottom: 122px;
  height: 50px;
`

export const BottomWaypoint = styled.span`
  position: absolute;
  bottom: 122px;
  width: 100%;
`
